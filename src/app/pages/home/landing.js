            ...
            verticalSlider: function() {
                var swiper = new Swiper("#projectSlider", {
                    ...
                    onSlideChangeStart: function(swipe) {
                        $(".slide-number").html("0" + (swipe.activeIndex + 1)), swipe.activeIndex + 1 === swipe.slides.length ? $(".btn-next-slide").addClass("last") : $(".btn-next-slide").removeClass("last")
                    }
                });
        ...
        var codeBlock = $("#rodinCode"),
            ...
            BANNER = {
                ...
                initDevicesSlider: function() {
                    ...
                    options = $.extend({}, options, {
                        ...
                        onInit: function(slide) {
							...
							BANNER.showCodeBlock(codeBlock, devicePath, !0),
							setTimeout(function() {
                    ...
                    }), BANNER.slider = new Swiper("#devicesSlider", options)
                },
                ...
                showCodeBlock: function(block, devicePath, init) {
                    ...
                    init ? block.css(params) : block.animate(params),
					codeBlock.css({
                        opacity: 1
                    })
                },
