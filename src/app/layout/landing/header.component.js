class AppHeaderCtrl {
    constructor(AppConstants,$window, $scope, $rootScope, $state, $stateParams, $location, PagesService, PagesStore, EventBus) {
        'ngInject';
        this._$state = $state;
        this._$scope = $scope;
    ...
    setPagesDropdown() {
        if(window.innerWidth <= 992) {
            ...
            this.pagesSection1 = _.slice(this.pagesList, 0, 2);
            this.pagesSection2 = _.slice(this.pagesList, 2, this.pagesList.length);
        }
    }
