    ...
    angular.module('wysiwyg.module', ['colorpicker.module']).directive('wysiwyg', [
        ...
        function (wysiwgGuiElements) {
            ...
            var getMenuGroup = function () {
                return {
                    tag: 'div',
                    classes: 'wysiwyg-btn-group-margin'//btn-group btn-group-sm
                };
            };
