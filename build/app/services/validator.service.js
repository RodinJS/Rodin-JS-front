...
System.register([], function (_export, _context) {
  ...
  */
	...
	function Validator(AppConstants, $log) {
		...
		var ERRORCODES = AppConstants.ERRORCODES;
    ...
    * */
	...
	return {
		setters: [],
		execute: function () {
			Validator.$inject = ['AppConstants', '$log'];
